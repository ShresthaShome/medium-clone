<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            @endauth
            @guest
                <a href="{{ route('login') }}" class="px-3 py-5 transition ease-in-out duration-150">Sign In</a>
                <a href="{{ route('register') }}" class="pr-3 py-5 transition ease-in-out duration-150">Create an
                    account</a>
            @endguest
        </div>
    </div>
